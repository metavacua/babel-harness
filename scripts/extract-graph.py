...
_VINDEX_BASE = os.environ.get('LARQL_VINDEX_BASE', '/home/metavacua/larql-vindexes')
VINDEXFILE_HEADER = f"""\
# NOTE: Update the FROM path below to match your local smollm2-360m.vindex installation.
# Override via: LARQL_VINDEX_BASE=/your/path python3 scripts/extract-graph.py
